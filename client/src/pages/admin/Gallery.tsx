...
    queryKey: ['gallery'],
    queryFn: async () => {
      return await apiRequest('GET', '/api/gallery');
    },
...
      // The `uploaded_by` field should be set on the backend based on the authenticated user.
      await apiRequest('POST', '/api/gallery', imageData);
    },
    onSuccess: () => {
      toast({
        title: "Success",
