...
import { insertExamSchema, insertQuestionSchema } from "@shared/types";
...
import { BookOpen, Plus, Edit2, Trash2, Users, Clock } from "lucide-react";
import { z } from "zod";
    ...
    <Layout type="portal">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8" data-testid="admin-exams">
        ...
        <Tabs value={selectedExam ? "questions" : "exams"} onValueChange={(value) => {
          ...
          <TabsList>
            <TabsTrigger value="exams" data-testid="tab-exams">All Exams</TabsTrigger>
            {selectedExam && (
