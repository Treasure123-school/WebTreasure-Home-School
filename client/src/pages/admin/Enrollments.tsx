// client/src/pages/admin/Enrollments.tsx
...
export default function AdminEnrollments() {
  ...
  // ✅ FIX: Fetch enrollments from your backend API
  const { data: enrollments = [], isLoading: enrollmentsLoading, refetch } = useQuery<Enrollment[]>({
    queryKey: ['enrollments'],
    queryFn: async () => {
      const response = await apiRequest<{data: Enrollment[]}>('GET', '/api/enrollments');
      return response.data;
    },
    enabled: !!user && user.role_name === 'Admin',
  });

  // ✅ FIX: Update enrollment status mutation to use backend API
